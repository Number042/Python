...
class Parameters:
    ...
    def set_beam_parameters( self ):
        ...
        if self.pc == 45.6:
            param = { 'Nbun':16640, 'Np':1.7e11, 'sigZ':3.5e-3, 'epsX':.27e-9, 
                       'epsY':1e-12, 'betStX':0.15, 'betStY':0.8e-3, 'sigStX':6.4e-6,
                       'sigStY':28e-9, 'Lrnt':self.pc/511e-6, 'brho':10*self.pc/2.9979 }

        elif self.pc == 182.5:
            param = { 'Nbun':48, 'Np':2.3e11, 'sigZ':1.97e-3, 'epsX':1.46e-9, 
                      'epsY':2.9e-12, 'betStX':1., 'betStY':1.6e-3, 'sigStX':38.2e-6, 
                      'sigStY':68e-9, 'Lrnt':self.pc/511e-6, 'brho':10*self.pc/2.9979 }
